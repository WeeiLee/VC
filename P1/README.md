...
Se crea una matriz de dimensión 800x800 de valores iniciales 0 con un único plano. Se recorre las filas y columnas de un tablero de 8x8 casillas. Cuando se determina la suma de fila y columna en par, se colorea en blanco desde este pixel hasta su siguiente tanto fila como columna multiplicando por 100 (porque la tabla es de 800 píxeles).
